...
<h4 class="text-white" style="margin-top:1rem;">Programming Languages :</h4>

<div id="wrapper">
    <div class="viewport">
        <div class="cube">
            <div class="side">
                <div class="cubeimage">HTML</div>
            </div>
            <div class="side">
                <div class="cubeimage">CSS</div>
            </div>
            <div class="side">
                <div class="cubeimage">Laravel</div>
            </div>
            <div class="side">
                <div class="cubeimage">JavaScript</div>
            </div>
            <div class="side">
                <div class="cubeimage">PHP</div>
            </div>
            <div class="side">
                <div class="cubeimage">Bootstrap</div>
            </div>
        </div>
    </div>
</div>
